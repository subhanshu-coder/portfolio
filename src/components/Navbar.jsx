...
import "./Navbar.css"; // <-- We will modify this file's content
...
    setMenuOpen(false); // <--- This ensures the mobile menu closes
...
              // The class 'nav-pill' is added via CSS below
...
              {/* Removed original underline span as the active state will use the pill shape */}
